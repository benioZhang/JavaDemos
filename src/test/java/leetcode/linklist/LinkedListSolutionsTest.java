...
public class LinkedListSolutionsTest {
    ...
    public void hasCycle() throws Exception {
        ...
        list1.next = list1;
        Assert.assertTrue(LinkedListSolutions.hasCycle(list1));

        ListNode list2 = new ListNode(1);
        list2.next = new ListNode(2);
        Assert.assertFalse(LinkedListSolutions.hasCycle(list2));

        ListNode list3 = new ListNode(1);
        list3.next = new ListNode(2);
        list3.next.next = list3.next;
        Assert.assertTrue(LinkedListSolutions.hasCycle(list3));
    }
    ...
    public void detectCycle() throws Exception {
        ListNode list1 = new ListNode(1);
        list1.next = list1;
        Assert.assertEquals(LinkedListSolutions.detectCycle(list1), list1);

        ListNode list2 = new ListNode(1);
        list2.next = new ListNode(2);
        Assert.assertNull(LinkedListSolutions.detectCycle(list2));

        ListNode list3 = new ListNode(1);
        list3.next = new ListNode(2);
        list3.next.next = list3.next;
        Assert.assertEquals(LinkedListSolutions.detectCycle(list3), list3.next);
    }
    ...
    public void getIntersectionNode() {
        ...
        Assert.assertEquals(intersectionNode, LinkedListSolutions.getIntersectionNode(headA, headB));
        ...
        headB.next = new ListNode(8);
        headB.next.next = new ListNode(7);
        Assert.assertNull(LinkedListSolutions.getIntersectionNode(headA, headB));
    }
    ...
    public void removeNthFromEnd() {
        ...
        list2 = LinkedListSolutions.removeNthFromEnd(list1, 1);
        ...
        list2 = LinkedListSolutions.removeNthFromEnd2(list1, 5);
        Assert.assertEquals(head, list2);
        Assert.assertEquals(Arrays.asList(2, 3, 4, 5), getLinkedListValue(list2));

        list1 = createLinkedList(5);// 1->2->3->4->5
        list2 = LinkedListSolutions.removeNthFromEnd(list1, 2);
        Assert.assertEquals(list1, list2);
    ...
    public void removeNthFromEnd2() {
        ListNode list1, list2;
        list1 = createLinkedList(1);// 1
        list2 = LinkedListSolutions.removeNthFromEnd2(list1, 1);
        Assert.assertEquals(null, list2);
        Assert.assertEquals(Collections.emptyList(), getLinkedListValue(list2));
        ...
        list1 = createLinkedList(5);// 1->2->3->4->5
        list2 = LinkedListSolutions.removeNthFromEnd2(list1, 2);
        Assert.assertEquals(list1, list2);
        Assert.assertEquals(Arrays.asList(1, 2, 3, 5), getLinkedListValue(list2));
    ...
    public void reverseList() {
        ListNode list, node;
        Assert.assertNull(LinkedListSolutions.reverseList(null));

        list = createLinkedList(1);// 1
        Assert.assertEquals(list, LinkedListSolutions.reverseList(list));

        list = createLinkedList(2);// 1->2
        node = LinkedListSolutions.reverseList(list);
    ...
    public void reverseList2() {
        ListNode list, node;
        Assert.assertNull(LinkedListSolutions.reverseList2(null));

        list = createLinkedList(1);// 1
        Assert.assertEquals(list, LinkedListSolutions.reverseList2(list));

        list = createLinkedList(2);// 1->2
        node = LinkedListSolutions.reverseList2(list);
        Assert.assertEquals(list, node.next);
        Assert.assertEquals(Arrays.asList(2, 1), getLinkedListValue(node));
    ...
    public void removeElements() {
        ...
        Assert.assertNull(null, LinkedListSolutions.removeElements(list, 1));

        list = new ListNode(1);
        node = list.next = new ListNode(2);
        list.next.next = new ListNode(1);
        Assert.assertEquals(node, LinkedListSolutions.removeElements(list, 1));
        ...
        Assert.assertEquals(list, LinkedListSolutions.removeElements(list, 6));
    ...
    public void removeElements2() {
        ...
        list = new ListNode(1);
        list.next = new ListNode(1);
        Assert.assertNull(null, LinkedListSolutions.removeElements2(list, 1));

        list = new ListNode(1);
        node = list.next = new ListNode(2);
        list.next.next = new ListNode(1);
        Assert.assertEquals(node, LinkedListSolutions.removeElements2(list, 1));
        Assert.assertEquals(Arrays.asList(2), getLinkedListValue(node));
        ...
        list.next.next.next.next.next = new ListNode(5);
        list.next.next.next.next.next.next = new ListNode(6);
        Assert.assertEquals(list, LinkedListSolutions.removeElements2(list, 6));
        Assert.assertEquals(Arrays.asList(1, 2, 3, 4, 5), getLinkedListValue(list));
    }
    ...
    public void oddEvenList() {
        ListNode list;
        list = new ListNode(1);
        Assert.assertEquals(Arrays.asList(1), getLinkedListValue(LinkedListSolutions.oddEvenList(list)));

        list = createLinkedList(2);
        Assert.assertEquals(Arrays.asList(1, 2), getLinkedListValue(LinkedListSolutions.oddEvenList(list)));

        list = createLinkedList(3);
        Assert.assertEquals(Arrays.asList(1, 3, 2), getLinkedListValue(LinkedListSolutions.oddEvenList(list)));

        list = createLinkedList(4);
        Assert.assertEquals(Arrays.asList(1, 3, 2, 4), getLinkedListValue(LinkedListSolutions.oddEvenList(list)));

        list = createLinkedList(5);
        Assert.assertEquals(Arrays.asList(1, 3, 5, 2, 4), getLinkedListValue(LinkedListSolutions.oddEvenList(list)));
    }

    @Test
    public void isPalindrome() {
        ListNode list, node;
        Assert.assertTrue(LinkedListSolutions.isPalindrome(null));

        list = new ListNode(1);
        list.next = new ListNode(2);
        Assert.assertFalse(LinkedListSolutions.isPalindrome(list));

        node = list = new ListNode(1);
        node = node.next = new ListNode(2);
        node = node.next = new ListNode(2);
        node = node.next = new ListNode(1);
        Assert.assertTrue(LinkedListSolutions.isPalindrome(list));
    ...
    public void mergeTwoLists() {
        ...
        node = LinkedListSolutions.mergeTwoLists(null, null);
        Assert.assertNull(node);

        node = list1 = new ListNode(1);// 1->2->4
        node = node.next = new ListNode(2);
        node = node.next = new ListNode(4);
        node = LinkedListSolutions.mergeTwoLists(list1, null);
        Assert.assertEquals(node, list1);
        node = list2 = new ListNode(1);// 1->3->4
        node = node.next = new ListNode(3);
        node = node.next = new ListNode(4);
        node = LinkedListSolutions.mergeTwoLists(list1, list2);
        Assert.assertEquals(node, list1);
    ...
    public void mergeTwoLists2() {
        ListNode list1, list2, node;
        node = LinkedListSolutions.mergeTwoLists2(null, null);
        Assert.assertNull(node);

        node = list1 = new ListNode(1);// 1->2->4
        node = node.next = new ListNode(2);
        node = node.next = new ListNode(4);
        node = LinkedListSolutions.mergeTwoLists2(list1, null);
        Assert.assertEquals(node, list1);
        node = list2 = new ListNode(1);// 1->3->4
        node = node.next = new ListNode(3);
        node = node.next = new ListNode(4);
        node = LinkedListSolutions.mergeTwoLists2(list1, list2);
        Assert.assertEquals(node, list1);
        Assert.assertEquals(Arrays.asList(1, 1, 2, 3, 4, 4), getLinkedListValue(node));
    ...
    public void addTwoNumbers() {
        ...
        node = LinkedListSolutions.addTwoNumbers(list1, list2);
    ...
    public void addTwoNumbers2() {
        ...
        list2 = new ListNode(9);
        list2.next = new ListNode(9);
        node = LinkedListSolutions.addTwoNumbers2(list1, list2);
        Assert.assertEquals(Arrays.asList(0, 0, 1), getLinkedListValue(node));
    ...
    public void flatten() {
        ...
        list1 = LinkedListSolutions.flatten(list1);
    ...
    public void copyRandomList() {
        ...
        head2 = LinkedListSolutions.copyRandomList(head);
    ...
    public void rotateRight2() {
        ListNode head, head2;
        head = createLinkedList(2);//1->2
        head2 = LinkedListSolutions.rotateRight2(head, 5);
        Assert.assertEquals(Arrays.asList(2, 1), getLinkedListValue(head2));

        head = createLinkedList(5);// 1->2->3->4->5
        head2 = LinkedListSolutions.rotateRight2(head, 2);
        Assert.assertEquals(Arrays.asList(4, 5, 1, 2, 3), getLinkedListValue(head2));
    }
    ...
    public void rotateRight3() {
        ListNode head, head2;
        head = createLinkedList(2);//1->2
        head2 = LinkedListSolutions.rotateRight3(head, 5);
        Assert.assertEquals(Arrays.asList(2, 1), getLinkedListValue(head2));

        head = createLinkedList(5);// 1->2->3->4->5
        head2 = LinkedListSolutions.rotateRight3(head, 4);
        Assert.assertEquals(Arrays.asList(2, 3, 4, 5, 1), getLinkedListValue(head2));

        head = createLinkedList(5);// 1->2->3->4->5
        head2 = LinkedListSolutions.rotateRight3(head, 1);
